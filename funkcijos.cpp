...
template void prep (vector<studentas>&, int, int, int&, int, string, string, int, vector<double>&, vector<double>&, vector<double>&, vector<string>&, vector<double>&);
template void prep (list<studentas>&, int, int, int&, int, string, string, int, vector<double>&, vector<double>&, vector<double>&, vector<string>&, vector<double>&);
template void prep (deque<studentas>&, int, int, int&, int, string, string, int, vector<double>&, vector<double>&, vector<double>&, vector<string>&, vector<double>&);